        ...
        <>
            <View style={styles.container}>
                <InputField
                    ...
                    // onChangeText={(text) => setSignupValues((prev) => ({...prev, email: text}))}
                ...
                <InputField
                    ...
                    // onChangeText={(text) => setSignupValues((prev) => ({...prev, password: text}))}
                ...
                <InputField
                    ...
                    // onChangeText={(text) => setSignupValues((prev) => ({...prev, passwordConfirm: text}))}
                    onChangeText={(text) => handleChangeInput(text, "passwordConfirm")}
                />
            </View>
            <FixedBottomCTA label={"로그인하기"} onPress={handleSubmit}/>
        </>
    );
}
